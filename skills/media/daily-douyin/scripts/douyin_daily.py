...
# 状态文件
STATE_FILE = "/Users/twliang/.openclaw/scripts/douyin_state.json"
CACHE_FILE = "/Users/twliang/.openclaw/scripts/douyin_content_cache.json"
...
def make_text(text):
    ...
    for part in parts:
        if part.startswith('**') and part.endswith('**'):
            ...
            elements.append({"type": "text_run", "text_run": {"content": part}})
    if not elements:
