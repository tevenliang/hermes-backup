...
参考 daily-ai-news-skill 四阶段设计：
  ...
  Phase 4: 格式化输出 + 今日要点
"""
import subprocess, urllib.request, json, re
from datetime import datetime, timedelta

NOW = datetime.now()
NOW_STR = NOW.strftime('%Y-%m-%d')
CLI_TENCENT = '/root/.openclaw/workspace/skills/tencent-news/tencent-news-cli'
CLI_WECHAT = '/root/.openclaw/workspace/skills/wechat-article-search/scripts/search_wechat.js'
